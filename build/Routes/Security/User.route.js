...
var IdType = require('../../Models/Security/IdType');

var Role = require('../../Models/Security/Role');

router.post('/create', UserController.create);
router.get('/', function (req, res) {
  User.findAll(_defineProperty({
    include: [{
      model: Token,
      as: "token",
      attributes: ['token']
...
module.exports = router; //attributes: ['firstname', 'firstlastname']